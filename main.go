// ref: https://github.com/hanwen/go-fuse/blob/e73817414197884414aad76cf99983fa442ee3ce/example/hello/main.go
package main
...
func (me *HelloFs) OpenDir(name string, context *fuse.Context) (c []fuse.DirEntry, code fuse.Status) {
  if name == "" {
    c = []fuse.DirEntry{{Name: "hello.txt", Mode: fuse.S_IFREG}}
    return c, fuse.OK
  }
  return nil, fuse.ENOENT
}
